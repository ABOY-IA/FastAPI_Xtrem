...
def refresh_and_rotate_token(
    ...
    correspond à celui stocké. Ensuite, un nouveau access token et un nouveau refresh token
    sont générés, le refresh token en base est mis à jour, et les nouveaux tokens sont renvoyés.
    """
    ...
    # Récupérer l'utilisateur en base et vérifier le refresh token stocké
    ...
    # Mettre à jour le refresh token stocké en base pour l'utilisateur
